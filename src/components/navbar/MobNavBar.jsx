...
const MobNavBar = () => {
    return (
        <div data-aos="fade-down" className="hidden md:flex fixed bottom-4 left-1/2 -translate-x-1/2 bg-[#0f111c] px-4 py-4 rounded-xl items-center justify-between gap-4 z-50 shadow-lg"
            style={{
                width: '90%',
